...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 654.0, 32.0, 23.0 ],
					"style" : "",
					"text" : "r cc"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 49.0, 691.0, 114.0, 61.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 305.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "r bb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 282.0, 32.0, 23.0 ],
					"style" : "",
					"text" : "r aa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.0, 126.0, 140.0, 53.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 83.0, 189.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 937.0, 160.0, 84.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 720.0, 171.0, 84.0, 33.0 ],
					"style" : "",
					"text" : "mix-v1.M.1.29.wav",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1068.0, 529.0, 38.0, 23.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1068.0, 560.0, 39.0, 23.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1054.0, 504.0, 32.5, 23.0 ],
					"style" : "",
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1054.0, 588.0, 78.0, 23.0 ],
					"style" : "",
					"text" : "sfrecord~ 2"
				}
...
,
					"patching_rect" : [ 956.0, 474.5, 93.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Osaka",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 784.0, 47.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 390.0, 495.0, 345.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 512.0, 274.0, 119.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.5, 200.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 725.5, 529.5, 58.5, 529.5 ],
					"source" : [ "obj-108", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 399.5, 527.5, 58.5, 527.5 ],
					"source" : [ "obj-108", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 369.5, 507.0, 544.5, 507.0 ],
					"source" : [ "obj-112", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "x_sugar~.maxpat",
				"bootpath" : "~/Dropbox (PPCA)/sss courses/2010-2012/Synth/Synth Lesson 12 granular/granularF",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}

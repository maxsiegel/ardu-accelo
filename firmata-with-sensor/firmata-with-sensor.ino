...
//  }
if (analogPin==0) {
 Firmata.sendAnalog(analogPin,round(1024*(10+accel.acceleration.x)/1.0) );
}
if (analogPin==1) {
 Firmata.sendAnalog(analogPin,round(1024*(10+accel.acceleration.y)/1.0) );
}
if (analogPin>=2) {
 Firmata.sendAnalog(analogPin,round(1024*(10+accel.acceleration.z)/1.0) );
}
...
//    Firmata.processInput();
//  }
//  Firmata.sendAnalog(analogPin,round(accel.acceleration.z*10) );
//  analogPin = analogPin + 1;
